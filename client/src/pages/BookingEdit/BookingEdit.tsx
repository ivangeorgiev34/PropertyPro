...
export const BookingEdit: React.FC = () => {
  ...
  const { formValues, onFormChange, setDefaultValues } =
    useForm<IBookingEditForm | null>(null);
  ...
  const onEditBookingFormSubmit: FormEventHandler<HTMLFormElement> = async (
      ...
      {booking !== null ? (
        <div className={styles.bookingEditCardWrapper}>
          <form
            ...
            className={styles.bookingEditCard}
            onSubmit={onEditBookingFormSubmit}
          >
            <h2>Edit booking</h2>
            <hr />
            ...
            <div className={styles.inputContainer}>
              ...
              <input
                ...
                onChange={onFormChange}
                onBlur={(e) =>
                  onFormErrorChange(e, guestsValidation(formValues?.guests!))
                }
              />
