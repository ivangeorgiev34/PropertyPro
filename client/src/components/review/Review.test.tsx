...
describe("Review", () => {
    ...
    test("delete button click error message span should not be empty when window confirm is true", () => {
        ...
        jest.spyOn(reviewService, "deleteReviewById")
            .mockResolvedValue({
                status: "Error",
    ...
    test("profile picture should not show when tenant's profile picture is null", () => {
        ...
        const expectedResult = "https://thumbs.dreamstime.com/b/user-icon-flat-style-isolated-grey-background-user-icon-flat-style-isolated-grey-background-your-design-logo-131213475.jpg";
