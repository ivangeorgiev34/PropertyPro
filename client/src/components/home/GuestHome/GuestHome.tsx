            ...
            <section className={styles.introductionSection}>
                <div className={styles.introductionContent}>
                    ...
                    <div className={styles.introductionBtnsContainer}>
                        <Link to={"/register"} className={styles.introductionGetStartedBtn}>Get Started!</Link>
                        <Link to={"/login"} className={styles.introductionSignInBtn}>Sign In!</Link>
                    </div>
                </div>
                <img
                    className={styles.introductionImage}
                    src="https://th.bing.com/th/id/OIP.yEgpuy6GlRBNVJhDyF-PfAHaE8?pid=ImgDet&rs=1"
                    alt="" />
            </section>
                ...
                <div className={styles.testimonialCards}>
                    <div className={styles.testimonialCard}>
                        <img
                            ...
                            alt="" />
                        <span className={styles.testimonialPersonName}>Amanda Mitchell, Landlord</span>
                        <p className={styles.testimonialContent}>I am so pleased with PropertyPro! I have searched for a more capable and functional property rental portal like this, and I could not find any better!</p>
                    ...
                    <div className={styles.testimonialCard}>
                        <img
                            ...
                            alt="" />
                        <span className={styles.testimonialPersonName}>Matthew Tracy, Tenant</span>
                        <p className={styles.testimonialContent}>Back when I didn't know about PropertyPro, I was helplessly searching for a holiday destination in which me and my family could go to. But when I found out about ProeprtyPro everything changed!</p>
                        <ul className={styles.starsList}>
                            <li><i className={`fa-solid fa-star ${styles.yellowStar}`}></i></li>
                            <li><i className={`fa-solid fa-star ${styles.yellowStar}`}></i></li>
                            <li><i className={`fa-solid fa-star ${styles.yellowStar}`}></i></li>
                    ...
                    <div className={styles.testimonialCard}>
                        <img
                            ...
                            alt="" />
                        <span className={styles.testimonialPersonName}>John Curry, Landlord</span>
                        <p className={styles.testimonialContent}>I have been searching for this type of platform for ages! A year ago I found the perfect one, and that is PropertyPro, which has helped me a ton in getting more customers over the past year.</p>
                        <ul className={styles.starsList}>
                            <li><i className={`fa-solid fa-star ${styles.yellowStar}`}></i></li>
                            <li><i className={`fa-solid fa-star ${styles.yellowStar}`}></i></li>
                            <li><i className={`fa-solid fa-star ${styles.yellowStar}`}></i></li>
