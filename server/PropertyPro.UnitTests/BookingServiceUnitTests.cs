...
namespace PropertyPro.UnitTests
{
    ...
    public class BookingServiceUnitTests
    {
        ...
        public async Task Test_Method_CanBookingBeBooked_ShouldReturnTrueWhenCannotBookBooking()
        {
            ...
            var actualResult = await bookingService.CanBookingBeBooked(new DateTime(2023, 12, 26), new DateTime(2023, 12, 28), searchedPropertyId);
        ...
        public async Task Test_Method_CanBookingBeBooked_ShouldReturnFalseWhenCanBookBooking()
        {
            ...
            var actualResult = await bookingService.CanBookingBeBooked(new DateTime(2023, 12, 27), new DateTime(2023, 12, 28), searchedPropertyId);
